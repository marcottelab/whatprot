...
def find_path():
    lib_paths = [ os.path.abspath('/mnt/c/Users/Matthew/ICES/MarcotteLab/git/Fluoroseq/cc_code/extern/flann-1.9.1/build/lib'), abspath(join(dirname(dirname(sys.argv[0])), '../../../lib')) ]
